...
export class State {
  ...
  radioType = 'wifi-none';
  capabilitiesHeader = '3brTv10='; //capabilitiesHeader = '3brTvwE=';
  ...
  public get cookieUserId() {
    ...
    return this.parsedAuthorization.ds_user_id; //return this.extractCookieValue('ds_user_id');
  }
  ...
  public async deserialize(state: string | any): Promise<void> {
    ...
    if (typeof obj !== 'object') {
      ...
      throw new TypeError("State isn't an object or serialized JSON"); //throw new TypeError('State isn\'t an object or serialized JSON');
    }
